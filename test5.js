...
//=============================================================================
    kintone.events.on('app.record.index.show' , function(event) {
        ...
        var $btnSample1 = $("<button>", { id: "btn_sample1"}).append(" button");
        
        $indexHeader.append($btnSample1);
        
        var $btnArea = $('#btnArea');
        var $btnSample2 = ("<button>", { id: "btn_sample2"}).append(" button");
       ...
       }); //   end $btnSample.onclick
       
       $btnSample2on('click', function(e){
